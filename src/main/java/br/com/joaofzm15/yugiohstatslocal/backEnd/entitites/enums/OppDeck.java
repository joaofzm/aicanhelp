package br.com.joaofzm15.yugiohstatslocal.backEnd.entitites.enums;
...
public enum OppDeck {
	...
	public static OppDeck returnTheOppDeckThatCorespondsToTheParameterIntegerCode(int code) {
